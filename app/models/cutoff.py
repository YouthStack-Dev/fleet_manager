from sqlalchemy import Column, String, DateTime, ForeignKey, func, Interval, Boolean, Integer, CheckConstraint
...
class Cutoff(Base):
    ...
    escort_enabled = Column(Boolean, nullable=False, server_default="false")
