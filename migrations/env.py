"""Alembic environment configuration for Fleet Manager database migrations."""
...
try:
    ...
    pass  # IAM models might not exist yet
...
# Set the SQLAlchemy URL from your app's settings
